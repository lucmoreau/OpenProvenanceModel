    ...
    extends TestCase
{
     ...
     */
    public Multi1Test( String testName )
    {
        super( testName );
    }
    ...
    public void testMULTI1() throws JAXBException
    {
        ...
        serial.serialiseOPMGraph(new File("target/multi1.xml"),graph,true);

        
        //System.out.println(sw);

        graph1=graph;
        System.out.println("MULTI1 Test asserting True");
        assertTrue( true );
     ...
     * of created graph. */
    public void testMULTI1Conversion() throws java.io.FileNotFoundException,  java.io.IOException   {
