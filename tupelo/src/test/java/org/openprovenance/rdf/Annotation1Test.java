    ...
    extends TestCase
{
    ...
    public void testAnnotation1() throws JAXBException
    {
        ...
        oFactory.addAnnotation(a4,oFactory.newEmbeddedAnnotation("an11","http://property.org/hasQuality", "bad", orange));
        ...
        oFactory.addAnnotation(p5,oFactory.newEmbeddedAnnotation("an13","http://property.org/hasProperty", "beau", green));
